...
hawk.job-init() {
  ...
  #
  # Use the environment variable LACEWORK_JAVA_OFFLINE_MODE if you want to stop the Inline Scanner from accessing https://search.maven.org/solrsearch/select for Maven Java dependencies
